...
PYTHONPATH=. uv run python experiments/mirrors_content_analysis_2026_04_24/analysis/readability_complexity_analysis/main.py
"""
...
READABILITY_COMPLEXITY_ANALYSIS_DIR = Path(__file__).resolve().parent
LABELS_ORIGINAL_PATH = READABILITY_COMPLEXITY_ANALYSIS_DIR / "labels_original_text.csv"
LABELS_MIRRORS_PATH = READABILITY_COMPLEXITY_ANALYSIS_DIR / "labels_mirrors.csv"
...
class ReadabilityComplexityAnalyzer:
    ...
    def __init__(
        ...
        *,
        ...
        self.output_dir = READABILITY_COMPLEXITY_ANALYSIS_DIR / "outputs" / self.timestamp
    ...
    def export_metric_labels(self) -> tuple[pd.DataFrame, pd.DataFrame]:
        """Export per-post readability labels for original and mirrored texts."""
