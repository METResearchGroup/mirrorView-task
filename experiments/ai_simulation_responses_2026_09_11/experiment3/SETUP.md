...
Experiment 3 prepends the reflection question from the live study, the written answer, and the 1–7 influence rating, then the 20 post pairs. System prompt is `STUDY_SYSTEM_PROMPT` in `../shared/prompts.py`.
