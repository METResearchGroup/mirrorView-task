"""Run one-shot/original_plus_mirror/large keep/remove prompting.
...
from experiments.predict_keep_remove_2026_07_01.models.llm_api.one_shot.original_plus_mirror.large import (
...
def main(
    ...
    run_llm_prompt_variant(
        variant_slug="one_shot_original_plus_mirror_large",
