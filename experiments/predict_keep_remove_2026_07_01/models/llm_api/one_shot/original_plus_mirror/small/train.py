"""Run one-shot/original_plus_mirror/small keep/remove prompting.

Run from root: PYTHONPATH=. uv run python experiments/predict_keep_remove_2026_07_01/models/llm_api/one_shot/original_plus_mirror/small/train.py
"""
...
from experiments.predict_keep_remove_2026_07_01.models.llm_api.one_shot.original_plus_mirror.small import (
...
def main(
    ...
    run_llm_prompt_variant(
        variant_slug="one_shot_original_plus_mirror_small",
