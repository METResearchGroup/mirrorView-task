"""Run one-shot/original/small keep/remove prompting.

Run from root: PYTHONPATH=. uv run python experiments/predict_keep_remove_2026_07_01/models/llm_api/one_shot/original/small/train.py
"""
...
from experiments.predict_keep_remove_2026_07_01.models.llm_api.one_shot.original.small import (
...
def main(
    ...
    variant_slug = "one_shot_original_small"
