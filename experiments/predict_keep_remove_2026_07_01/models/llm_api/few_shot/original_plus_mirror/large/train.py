"""Run few-shot/original_plus_mirror/large keep/remove prompting.

Run from root: PYTHONPATH=. uv run python experiments/predict_keep_remove_2026_07_01/models/llm_api/few_shot/original_plus_mirror/large/train.py
"""
...
from experiments.predict_keep_remove_2026_07_01.models.llm_api.few_shot.original_plus_mirror.large import (
...
def main(
    ...
    run_llm_prompt_variant(
        variant_slug="few_shot_original_plus_mirror_large",
        model_name=constants.MODEL_ID_BY_SIZE["large"],
        model_size="large",
        prompt_type="few_shot",
        input_mode="original_plus_mirror",
