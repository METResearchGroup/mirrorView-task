"""Run few-shot/original/large keep/remove prompting.

Run from root: PYTHONPATH=. uv run python experiments/predict_keep_remove_2026_07_01/models/llm_api/few_shot/original/large/train.py
"""
...
from experiments.predict_keep_remove_2026_07_01.models.llm_api.few_shot.original.large import (
...
def main(
    ...
    run_llm_prompt_variant(
        variant_slug="few_shot_original_large",
