"""Train XGBoost using (orig_emb - mirror_emb) only.

Run from repo root::

    PYTHONPATH=. uv run python experiments/predict_keep_remove_2026_07_01/models/xgboost/train_difference_embedding.py
"""
...
def main(
    ...
    metadata = {
        ...
        "feature_set_description": (
            "Difference-only fixed dense features: (orig_emb - mirror_emb)."
        ),
