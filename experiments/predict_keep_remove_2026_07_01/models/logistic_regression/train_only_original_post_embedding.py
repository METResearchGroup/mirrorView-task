"""Train logistic regression using original post embedding only.

Run from repo root::

    PYTHONPATH=. uv run python experiments/predict_keep_remove_2026_07_01/models/logistic_regression/train_only_original_post_embedding.py
"""
