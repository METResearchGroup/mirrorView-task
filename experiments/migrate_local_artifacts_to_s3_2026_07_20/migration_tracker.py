...
class MigrationTracker:
    ...
    def register_files(
        ...
        *,
        ...
        Returns counts: inserted / already_present / refreshed / skipped_empty.
    ...
    def get_files_to_upload(
        ...
        *,
        ...
        """status IN ('pending','in_progress'); optional prefix; ORDER BY local_path."""
        sql = """
            SELECT *
    ...
    def force_reupload(self, local_paths: list[str]) -> int:
        """Reset completed/verified/failed → pending for given paths."""
        if not local_paths:
            return 0
        now = _utc_now()
