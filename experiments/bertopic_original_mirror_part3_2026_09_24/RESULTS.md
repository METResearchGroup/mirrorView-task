...
Date: 2026-09-24. Status: Complete.
...
Part 3 reuses much of the Part 2 structure and also shifts topic shares. Shares, the crosstab, and facet charts are in `outputs/analyses/part2_comparison/20260924T053524Z`.
...
## Q3. Does the mirror generator leave a signature?

In the joint model, a pair is co-assigned 49.7% of the time. 70 of 144 topics (including noise) have an original-text share outside 35% to 65% after a false-discovery-rate correction. Some joint topics are mostly originals or mostly mirrors.
...
## Q5. Which topics are removed more often?

Among posts with at least 3 raters, the keep rate is 69.4% (15,846 posts). The noise topic (6,443 posts) is close to that, at 68.9%. 37 non-noise topics differ from the overall rate after a Benjamini-Hochberg correction. Intervals are cluster bootstraps of 2,000 resamples by post.
...
Lowest keep rates are anti-Trump topics:
...
- A1. UMAP seeds 42–46. Seed 42 matches the production fit (ARI 1.0). Mean pairwise ARI across seeds is 0.57. Topic count moves from 86 to 99. The partition is only moderately stable.
- A2. Minimum cluster size 15, 30, and 50. Topic count falls from 92 to 42 to 30. Noise share stays near 36–40%.
...
- Reviews: `outputs/reviews/20260924T055615Z`
