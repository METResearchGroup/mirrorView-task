# Part 2+3 LoRA fine-tune setup

## Prerequisites

Step 1 label CSVs and registry keys (Part 2 and Part 3 union):

- `STUDY_PHASE_2_PART_2_AND_3_KEEP_REMOVE_LABELS`: modal labels (20,000 posts, includes `n_raters`)
- `STUDY_PHASE_2_PART_2_AND_3_KEEP_REMOVE_LABELS_UNANIMOUS_MIN3`: unanimous min-3 labels (5,715 posts)
...
## Output counts (seed 1)

| Output | Rows |
| --- | ---: |
| Modal label pool | 20,000 |
| Unanimous min-3 pool | 5,715 |
| Experiment 1 train | 702 (351 keep + 351 remove) |
| Experiment 2 train | 7,686 |
| Experiment 3 train | 702 (matches Exp 1) |
| Unanimous test | 168 (84 + 84) |
| Modal test | 1,922 (961 + 961) |
...
for dir in data experiment1_unanimous/data experiment2_modal/data experiment3_modal_size_matched/data; do
  /workspace/.venv/bin/aws s3 sync "experiments/finetune_lora_phase2_part3_2026_09_24/${dir}/" \
