"""Train XGBoost model on embeddings + categorical metadata."""
...
def build_xy_from_joined(df: pd.DataFrame, mt: EmbeddingMetadataMatrixBuilder):
    for c in (JOIN_COL_ORIGINAL, JOIN_COL_MIRROR, "keep_remove_label"):
...
def main(
    ...
    metadata = {
        ...
        "feature_set_description": (
            "Same dense embedding interactions + stance/toxicity one-hot features as logistic baseline."
        ),
