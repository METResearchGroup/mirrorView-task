...
We collected some pilot data for our study. This folder contains some basic analysis of the free-response feedback and ratings, broken down by party and by condition (`training` vs. `training_assisted`).

Some things we hoped to answer during this analysis include:

- Whether assisted training looks more influential than unassisted training (from a self-report standpoint)
