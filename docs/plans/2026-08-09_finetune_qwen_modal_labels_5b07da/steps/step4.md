...
Add a custom Docker image and SageMaker launcher for `experiments/finetune_qwen_model_modal_labels_2026_08_09/` that preserve PR #54’s three modes (`train` / `infer_baseline` / `infer_adapter`) on `ml.g5.xlarge` in `us-east-2`, but use the **new** ECR repo and S3 prefix. The image **must copy both** experiment packages so imports from `experiments.finetune_qwen_model_2026_08_08` resolve at runtime.
...
```bash
docker build -f experiments/finetune_qwen_model_modal_labels_2026_08_09/Dockerfile \
  -t mirrorview-finetune_qwen_model_modal_labels_2026_08_09:latest .
```
...
PYTHONPATH=. uv run --extra finetune-qwen-2026-08-08 python \
  experiments/finetune_qwen_model_modal_labels_2026_08_09/launch_sagemaker.py \
...
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/Dockerfile`
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/entrypoint.sh`
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/.dockerignore` (and/or root `.dockerignore` only if required for dual-experiment COPY)
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/launch_sagemaker.py`
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/tests/test_launch_sagemaker_config.py`
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/README.md` (build/push/launch commands)
...
| `PYTHONPATH` | `/app` |
| COPY | `shared/`, `lib/`, `experiments/finetune_qwen_model_2026_08_08/`, `experiments/finetune_qwen_model_modal_labels_2026_08_09/` |
...
| ECR repo | `mirrorview-finetune_qwen_model_modal_labels_2026_08_09` |
| S3 bucket | `mirrorview-experimental-artifacts` |
| S3 prefix | `mirrorview-finetune_qwen_model_modal_labels_2026_08_09` |
...
PYTHONPATH=. uv run --extra finetune-qwen-2026-08-08 pytest \
  experiments/finetune_qwen_model_modal_labels_2026_08_09/tests/test_launch_sagemaker_config.py -q

# Docker build (when Docker available in the environment)
docker build -f experiments/finetune_qwen_model_modal_labels_2026_08_09/Dockerfile \
  -t mirrorview-finetune_qwen_model_modal_labels_2026_08_09:latest .

docker run --rm mirrorview-finetune_qwen_model_modal_labels_2026_08_09:latest train --help
docker run --rm mirrorview-finetune_qwen_model_modal_labels_2026_08_09:latest infer_baseline --help
docker run --rm mirrorview-finetune_qwen_model_modal_labels_2026_08_09:latest infer_adapter --help

# Confirm prior package is inside the image
docker run --rm --entrypoint python mirrorview-finetune_qwen_model_modal_labels_2026_08_09:latest -c \
  "import experiments.finetune_qwen_model_2026_08_08, experiments.finetune_qwen_model_modal_labels_2026_08_09; print('both packages OK')"
```
