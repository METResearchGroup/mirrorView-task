...
Execute the end-to-end remote teachability run for the modal-label experiment: upload frozen local data, ensure the ECR image is pushed, submit train then both inference jobs, sync prediction CSVs, and write `experiments/finetune_qwen_model_modal_labels_2026_08_09/RESULTS.md` in the **same table shape** as PR #54.
...
2. Upload `experiments/finetune_qwen_model_modal_labels_2026_08_09/data/` → `s3://mirrorview-experimental-artifacts/mirrorview-finetune_qwen_model_modal_labels_2026_08_09/data/`.
3. Build/tag/push ECR image `mirrorview-finetune_qwen_model_modal_labels_2026_08_09:latest` in `us-east-2`.
...
9. Sync preds locally under `experiments/finetune_qwen_model_modal_labels_2026_08_09/preds/`.
...
| Path | Why |
|------|-----|
| `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/README.md` | Operator commands |
| `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/launch_sagemaker.py` | Launch interface |
| `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/evaluate.py` | RESULTS writer |
...
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/preds/**` (synced artifacts)
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/RESULTS.md`
- `/workspace/experiments/finetune_qwen_model_modal_labels_2026_08_09/README.md` (run record)
...
aws s3 sync experiments/finetune_qwen_model_modal_labels_2026_08_09/data/ \
  s3://mirrorview-experimental-artifacts/mirrorview-finetune_qwen_model_modal_labels_2026_08_09/data/ \
  --region us-east-2

aws s3 ls s3://mirrorview-experimental-artifacts/mirrorview-finetune_qwen_model_modal_labels_2026_08_09/data/
# must show: train.csv test.csv chat_train.jsonl chat_test.jsonl
```

### ECR push

Same login/tag/push pattern as the prior README, substituting repo name `mirrorview-finetune_qwen_model_modal_labels_2026_08_09`.
...
```bash
aws s3 sync \
  s3://mirrorview-experimental-artifacts/mirrorview-finetune_qwen_model_modal_labels_2026_08_09/preds/ \
  experiments/finetune_qwen_model_modal_labels_2026_08_09/preds/ \
  --region us-east-2

PYTHONPATH=. uv run --extra finetune-qwen-2026-08-08 python \
  experiments/finetune_qwen_model_modal_labels_2026_08_09/evaluate.py \
  --preds-dir experiments/finetune_qwen_model_modal_labels_2026_08_09/preds \
  --write-results experiments/finetune_qwen_model_modal_labels_2026_08_09/RESULTS.md
```
