...
FEATURE_REGISTRY: dict[str, FeatureSpec] = {
    "is_news_or_opinion": FeatureSpec(
        ...
        export_filename="is_news_or_opinion.csv",
    ...
    "is_likely_spam": FeatureSpec(
        ...
        export_filename="is_likely_spam.csv",
    ...
    "is_self_contained": FeatureSpec(
        ...
        export_filename="is_self_contained.csv",
    ...
    "is_structurally_complete": FeatureSpec(
        ...
        export_filename="is_structurally_complete.csv",
    ...
    "is_toxic_tiered": FeatureSpec(
        ...
        export_filename="is_toxic_tiered.csv",
    ),
    "political_stance": FeatureSpec(
        ...
        export_filename="political_stance.csv",
